...
<head>
    ...
    <title>Persetujuan Anggota - Admin Basket SMKN 48</title>
...
<body>
    ...
    <main>
        <div class="page-header">
            <h2>Persetujuan Anggota Baru</h2>
        </div>
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th>Tgl. Daftar</th>
                        <th class="kolom-aksi" style="width: 200px;">Aksi</th>
                    </tr>
                </thead>
                <tbody id="tabel-pending-body">
    ...
    <script src="../js/script_persetujuan.js"></script>
</body>
</html>