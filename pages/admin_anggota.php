...
<head>
    ...
    <title>Kelola Anggota - Admin Basket SMKN 48</title>
...
<body>
    ...
    <main>
        <div class="page-header">
            <h2>Manajemen Anggota Eskul (Aktif)</h2>
        </div>
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th>Kelas</th>
                        <th>Email</th>
                        <th class="kolom-aksi" style="width: 250px;">Aksi</th>
                    </tr>
                </thead>
    ...
    <div id="modal-anggota" class="modal-overlay hidden">
        <div class="modal-content" style="max-width: 500px;">
            <div class="modal-header">
                <h3 id="modal-title">Edit Data Anggota</h3>
            ...
            <form id="form-anggota">
                <div class="modal-body">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="kelas" name="kelas" placeholder="Contoh: 11 TKJ 1" required>
                    </div>
                    <div class="input-group">
                        <label>Email (Tidak bisa diubah)</label>
                        <input type="email" id="email" name="email" readonly style="background:#eee;">
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" id="tombol-batal" class="btn-secondary">Batal</button>
                    <button type="submit" class="btn-primary-green">Update</button>
                </div>
            </form>
        </div>
    </div>
